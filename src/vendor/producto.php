        ...
        <div class="flex flex-col lg:flex-row lg:space-x-8">
            ...
            <div class="lg:w-1/2">
                <img src="<?php echo htmlspecialchars($chollo['imagen_chollo']); ?>"
                    alt="<?php echo htmlspecialchars($chollo['titulo_chollo']); ?>" class="rounded-lg shadow-md"
            ...
            <div class="lg:w-1/2 mt-8 lg:mt-0">
                ...
                <div class="mt-6">
                    <button
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 3h18M5 10h14l-1.5 6h-11L5 10z">
                        </path>
                        </svg>
                        Añadir al carrito
                    </button>
