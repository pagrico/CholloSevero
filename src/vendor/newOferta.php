...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <form>
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <div class="shrink-0 text-base text-gray-500 select-none sm:text-sm/6">workcation.com/
                                </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2 flex items-center gap-x-3">
                            ...
                            <button type="button"
                                class="rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-gray-50">Change</button>
                        </div>
                    </div>
        ...
        <div class="mt-6 flex items-center pb-10 justify-end gap-x-6">
