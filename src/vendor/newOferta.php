...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <form method="POST" action="administraroferta.php">
        ...
        <div class="mt-6 flex items-center pb-10 justify-end gap-x-6">
            ...
            <button type="submit"
                class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-indigo-600">Save</button>
        </div>
    </form>
</body>